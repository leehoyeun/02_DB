...
--테이블에 있는 모든 컬럼의 값을 인서트 할때 사용하는 구문
--단,컬럼의 순서를 지켜서 VALUES에 값을 기입해야함.

SELECT * FROM EMPLOYEE2  ;

INSERT INTO EMPLOYEE2 
VALUES('900','홍길동','991215-1234567','hong_gd@gmail.com','01097879848','D1',
...
ROLLBACK;
--DML 과 DDL을 석어서 쓰면 안됨
--DDL로 먼저 객체 생성을 다한 이후 DML 작성
...
VALUES ('900','홍길동','991215-1234567','ghdkd@or.kr',
 ...
 * [WHERE 컬럼명 비교연산자 = 비교값]; 
 * 
 * --> 전체를 수정하고 싶은게 아니라면 WHERE 절 조건 중요!
 * 
 * */
...
--WHERE 절을 기입하지 않아 DEPT_TILE 전부 기술연구팀으로 변경됨
ROLLBACK;
--마지막 커밋시점으로 되돌림
...
UPDATE DEPARTMENT2
SET DEPT_ID = 'D0',
DEPT_TITLE = '전략기획팀'--WHERE 절 직전 컬럼에는 컬럼 (,) 콤파X
WHERE  DEPT_ID = 'D9'
AND DEPT_TITLE = '총무부';
...
INSERT INTO EMP_M02
VALUES (999,'곽두원','561016-1234567','endnjs@ck.kr','01012345678',
...
-- 테이블의 전체 행을 삭제하는 DDL
-- DELETE 보다 수행속도 더 빠름
--DML이아니라 DDL 이기 때문에 ROLLBACK을 통해 복구 불가능
