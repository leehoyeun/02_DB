...
SELECT * FROM USER_TABLES; --: 계정이 소유한 객체 등에 관한 정보를 조회 할 수 있는 딕셔너리 뷰
SELECT * FROM USER_CONSTRAINTS; -- 계정이 작성한 제약조건을 확인할 수 있는 딕셔너리 뷰
SELECT * FROM USER_CONS_COLUMNS; --제약조건이 걸려있는 컬럼을 확인하는 딕셔너리 뷰
...
--UPDATE ROWS DML구문에서 행에 추가된 값이 있으면 보여지는값
...
--디폴트로 설정 되어있는 컬럼이라고 디폴트만 써야하는것은 아니다  컬럼 데이터 (SYSDATE) 타입에 맞게 삽입/수정 가능
...
INSERT INTO MEMBER(MEMBER_ID,MEMBER_PWD,MEMBER_NAME) VALUES ('MEM03','1Q2ASS','이지연');
...
--> NUMBER 타입 컬럼에 데이터 삽입시 제일앞에 0이 있으면 이를 자동으로 제거함
...
USER_NO NUMBER NOT NULL,--사용자번호 (모든사용자는 사용자 번호가 있어야한다!)
												--컬럼 레벨 제약조건 설정
USER_ID VARCHAR2(20),
...
INSERT INTO USER_USED_NN VALUES (1,'USER01','PASS01','홍길동','남자','010-1234-5678','hgodk@or.kr');

INSERT INTO USER_USED_NN VALUES (NULL,'USER01','PASS01','홍길동','남자','010-1234-5678','hgodk@or.kr');
...
--제약 조건 집적 안짓고 싶으면
-- 1) 컬럼 레벨   : [CONSTRAINT] 제약조건
-- 2) 테이블 레벨 : [CONSTRAINT] 제약조건(컬럼명)
...
'010-1234-5678','hgodk@or.kr');


SELECT * FROM USER_USEK_UK;
...
INSERT INTO USER_USED_UK2 VALUES (1,'USER01','PASS01','홍길동','남자','010-1234-5678','hgodk@or.kr');

SELECT * FROM USER_USED_UK2;

INSERT INTO USER_USED_UK2 VALUES (1,'USER02','PASS01','홍길동','남자','010-1234-5678','hgodk@or.kr');

SELECT * FROM USER_USED_UK2;

INSERT INTO USER_USED_UK2 VALUES (1,'USER01','PASS01','고길동','남자','010-1234-5678','hgodk@or.kr');
...
INSERT INTO USER_USED_PK VALUES (1,'USER01','PASS01','고길동','남자','010-1234-5678','hgodk@or.kr');

INSERT INTO USER_USED_PK VALUES (1,'USER02','PASS02','이순신','남자','010-1734-5698','hgZ_dk@or.kr');
--SQL Error [1] [23000]: ORA-00001: 무결성 제약 조건(KH.USER_NO_PK)에 위배됩니다
-->기본키 중복되서 오류남

INSERT INTO USER_USED_PK VALUES (NULL,'USER02','PASS02','이순신','남자','010-1734-5698','hgZ_dk@or.kr');
--SQL Error [1400] [23000]: ORA-01400: NULL을 ("KH"."USER_USED_PK"."USER_NO") 안에 삽입할 수 없습니다
-->키본키가 NULL 이므로 오류발생!

INSERT INTO USER_USED_PK VALUES (2,'USER02','PASS02','이순신','남자','010-1734-5698','hgZ_dk@or.kr');
...
INSERT INTO USER_USED_PK2 VALUES (1,'USER01','PASS01','홍길동','남자','010-1234-5678','hgZ_dk@or.kr');

SELECT * FROM USER_USED_PK2;

INSERT INTO USER_USED_PK2 VALUES (1,'USER02','PASS01','홍길동','남자','010-1234-5678','hgZ_dk@or.kr');

SELECT * FROM USER_USED_PK2;

INSERT INTO USER_USED_PK2 VALUES (2,'USER01','PASS01','홍길동','남자','010-1234-5678','hgZ_dk@or.kr');
...
INSERT INTO USER_USED_PK2 VALUES (NULL,'USER01','PASS01','홍길동','남자','010-1234-5678','hgZ_dk@or.kr');
--SQL Error [1400] [23000]: ORA-01400: NULL을 ("KH"."USER_USED_PK2"."USER_NO") 안에 삽입할 수 없습니다

INSERT INTO USER_USED_PK2 VALUES (2,NULL,'PASS01','홍길동','남자','010-1234-5678','hgZ_dk@or.kr');
...
-- 부모 테이블 / 참조할테이블 / 레퍼런스 테이블 (참조 대상이 되는 테이블)
...
REFERENCES USER_GRADE /*(GRADE_CODE)*/ --컬럼레벨
											--컬럼명 미작성 시 USER_CRADE 테이블의 PK를 자동 참조함.
--테이블 레벨
--,CONSTRANINT GRAD_CODE_FK FOREIGN KEY (GRADE_CODE)
...
INSERT INTO USER_USED_FK VALUES (1,'USER01','PASS01','홍길동','남자','010-1234-5678','hgZ_dk@or.kr',10);
--USER_GRADE (부모/참조테이블)에 10 이라는 GRADE_CODE 가 존재하기 때문에 가능
SELECT * FROM USER_USED_FK;

INSERT INTO USER_USED_FK VALUES (2,'USER02','PASS02','이순신','남자','010-9874-9513','nese_dk@or.kr',10);
SELECT * FROM USER_USED_FK;

INSERT INTO USER_USED_FK VALUES (3,'USER03','PASS03','유관순','여자','010-974-9813','needk@or.kr',30);
SELECT * FROM USER_USED_FK;
--USER_GRADE (부모/참조테이블)에 30 이라는 GRADE_CODE 가 존재하기 때문에 가능

INSERT INTO USER_USED_FK VALUES (4,'USER04','PASS04','안중근','남자','010-9974-9813','needk@or.kr',NULL);
SELECT * FROM USER_USED_FK;
--> NULL 사용 가능 

INSERT INTO USER_USED_FK VALUES (5,'USER05','PASS05','윤봉길','남자','010-6666-7788','yyondk@or.kr',50);
...
--GRADE_CODE중에 20은 사용 되지 않고 있으므로 삭제가 가능
DELETE FROM USER_GRADE WHERE GRADE_CODE=20;
SELECT * FROM USER_GRADE; --20 삭제된것 확인
ROLLBACK; --되돌기 .. 20이 돌아오도록
...
INSERT INTO USER_USED_FK3 VALUES (1,'USER01','PASS01','홍길동','남자','010-1234-5678','hgZ_dk@or.kr',10);
--USER_GRADE (부모/참조테이블)에 10 이라는 GRADE_CODE 가 존재하기 때문에 가능


INSERT INTO USER_USED_FK3 VALUES (2,'USER02','PASS02','이순신','남자','010-9874-9513','nese_dk@or.kr',10);


INSERT INTO USER_USED_FK3 VALUES (3,'USER03','PASS03','유관순','여자','010-974-9813','needk@or.kr',30);

--USER_GRADE (부모/참조테이블)에 30 이라는 GRADE_CODE 가 존재하기 때문에 가능

INSERT INTO USER_USED_FK3 VALUES (4,'USER04','PASS04','안중근','남자','010-9974-9813','needk@or.kr',NULL);
...
INSERT INTO USER_USED_CHECK VALUES (1,'USER01','PASS01','홍길동','남자','010-1234-5678','hgZ_dk@or.kr');
--SQL Error [2290] [23000]: ORA-02290: 체크 제약조건(KH.GENDER_CHECK)이 위배되었습니다
-- 남 , 여 만 가능한데 남자 라는 다른 문자열이 들어와 위배.
INSERT INTO USER_USED_CHECK VALUES (1,'USER01','PASS01','홍길동','남','010-1234-5678','hgZ_dk@or.kr');
SELECT * FROM USER_USED_CHECK; --남 입력완료 확인
INSERT INTO USER_USED_CHECK VALUES (2,'USER02','PASS02','사오정','여','010-1834-5678','saoZ_dk@or.kr');
SELECT * FROM USER_USED_CHECK; --여 입력완료 확인

--GENDER 컬럼에 CHECK 제약조건으로
-- '남' 또는 '여'만 삽입 가능하도록 설정해둠
-- 이 외의 값이 들어오면 체크 제약조건 위배되어 에러 발생!!
--위의 조건에 남과 여만 작성해두엇지만 더 설정해두면 더 가능
--만약 CHECK 조건이 AGE라는 컬럼에 있으면 AGE > 0 AND AGE < 100 이런식으로도 작성 가능
